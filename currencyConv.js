const countryList = {
  ...
  const BASE_URL = "https://v6.exchangerate-api.com/v6/3ba59f9310b127c208b8cdd5/latest/USD";
...
// Populate the dropdowns with countries
dropdowns.forEach((select) => {
  for (const [currency, countryCode] of Object.entries(countryList)) {
    ...
    if (select.classList.contains("from") && currency === "USD") {
      newOption.selected = "selected";
    } else if (select.classList.contains("to") && currency === "PKR") {
